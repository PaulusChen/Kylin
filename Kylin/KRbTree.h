...
static inline KRbNode *KRbMinimumTree(KRbTree *tree) {
    return KRbMinimum(tree->node);
}

static inline KRbNode *KRbMaximumTree(KRbTree *tree) {
    return KRbMaximum(tree->node);
}
